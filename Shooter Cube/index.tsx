...
import { PlaceWorld, getWorld } from './PlaceWorld';


const world1 = await getWorld({ worldId: '5uRMtUe2c', dev: false });
const world2 = await getWorld({ worldId: '5uLpptm36', dev: false });
const world3 = await getWorld({ worldId: '5uB_yX-3_', dev: false });
